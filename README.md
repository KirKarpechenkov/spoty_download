...
Возможны ошибки при конвертации. Для этого необходимо скачать последнюю stable версию с сайта ffmpeg: https://ffmpeg.org/download.html#releases и добавить в ./bin.
